...
function  bbnuke_drop_tables()
{
  ...
  $wpdb->query( "DROP TABLE IF EXISTS {$wpdb->prefix}nuke_baseballNuke_pitchTotals, 
                         {$mywpdb->prefix}nuke_baseballNuke_batTotals, 
                         {$mywpdb->prefix}nuke_baseballNuke_teams, 
                         {$mywpdb->prefix}nuke_baseballNuke_stats, 
                         {$mywpdb->prefix}nuke_baseballNuke_players, 
                         {$mywpdb->prefix}nuke_baseballNuke_locations, 
                         {$mywpdb->prefix}nuke_baseballNuke_boxscores, 
                         {$mywpdb->prefix}nuke_baseballNuke_settings, 
                         {$mywpdb->prefix}nuke_baseballNuke_schedule" );
